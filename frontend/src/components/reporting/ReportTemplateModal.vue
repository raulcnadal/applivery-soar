...
<template>
  <Teleport to="body">
    <div v-if="open" class="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 p-4" @click.self="close">
      <div class="w-full max-w-5xl h-[90vh] rounded-2xl shadow-2xl bg-white flex flex-col">
        <div class="flex items-center justify-between px-6 py-5 border-b border-gray-100 shrink-0">
          <div>
            <h2 class="text-base font-bold leading-tight text-gray-900">Custom HTML Template</h2>
          ...
          <button class="p-2 rounded-lg hover:bg-gray-100 text-gray-400 hover:text-gray-600 transition-colors shrink-0" aria-label="Close" @click="close">
        ...
        <div class="flex-1 p-6 overflow-hidden">
          <textarea
            v-model="draft"
            class="w-full h-full rounded-lg px-3 py-2 text-xs font-mono border border-gray-200 resize-none"
        ...
        <div class="px-6 py-4 border-t border-gray-100 flex items-center justify-between gap-3 shrink-0">
          ...
          <div class="flex items-center gap-2">
            <button class="px-4 py-2 rounded-lg text-sm font-medium text-gray-500 hover:bg-gray-50" @click="close">Close</button>
