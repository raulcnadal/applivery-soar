 ...
 * Auth is the single, workspace-wide GlobalBootstrapToken (X-Bootstrap-Token
 * header) plus a live Applivery UEM serial-number check — see
 * deviceMtls.service.ts's registerDevice for the full security model.
 *
